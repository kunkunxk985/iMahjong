        ...
        <div className="rules-body">
          <section className="rules-section">
            ...
            <ul className="rules-list">
              ...
              <li><b>杠：</b>手里三张遇别人打来的第四张可送杠；已“坎上”的三张由自己摸来第四张可自杠；杠后从牌尾补一张。碰出的牌不能再升级杠，本房不设补杠。</li>
          ...
          <section className="rules-section">
            ...
            <ol className="rules-steps">
              <li>先算每家的牌面胡数和幺数。</li>
              <li>先算每家的<b>固定牌面胡数</b>，不把任何一家的牌面胡直接改成“飘荤后胡数”。</li>
              <li>两家先查原始胡差；本笔涉及飘荤时，<b>原始胡差 ×2</b>；这一笔再涉及庄家时，胡差整体再 ×2。幺差不翻倍，最后另算幺差。</li>
              <li>飘荤胡家再向另外三家各收 30 分荤底；包庄时由包庄者承担相应份额。</li>
            </ol>
            <div className="rule-formula" aria-label="结算公式">
              <code>原始胡差 = A 牌面胡 − B 牌面胡</code>
              <code>本笔结算胡差 = 原始胡差 × 飘荤倍率 × 庄家倍率</code>
            </div>
            <div className="rule-example">
              <b>例：飘荤闲家 17 胡，对庄家 6 胡</b>
              <span>先查胡差 17−6=11，再按飘荤结算 11×2=22；因涉及庄家，最终胡差为 22×2=<strong>44 胡</strong>。</span>
              <small>庄家和飘荤都只作用于这笔胡差，不直接改任何人的牌面胡，也不翻幺差或荤底。</small>
            </div>
          </section>
          ...
          <details className="rules-advanced" open>
            ...
            <div className="rules-advanced-body">
              <p><b>飘荤：</b>已有三组碰、坎或杠且手里剩两对，或已有四组碰、坎或杠且手里剩单张后胡牌。飘荤不改牌面胡，只在每组查胡结算中将原始胡差 ×2，并另收每家 30 分荤底。</p>
              <p><b>关门：</b>四组完成后单钓会自动关门；三组碰、坎或杠后剩两对，可以主动关门。两对关门后若拆对换听，关门立即失效；关门本身不加胡。公开规则另注明：两对关门玩家不受“包香不包臭”限制。</p>
              <ol className="rules-bao-list">
                ...
                <li><b>包香不包臭：</b>三组碰、坎或杠加两对但<b>未选择两对关门</b>时，被此前全桌从未打出过的“香牌”（生张）点炮，由出牌者按飘荤包庄；已打出过的熟张（“臭牌”）不包庄。选择两对关门后，不受这条包香规则限制。</li>
              </ol>
              <p className="rule-footnote">包庄表示先完整查六组两两差胡，再由点炮者代付另外两家原本应向胡家支付的正向份额；胡家与高胡玩家、以及其他玩家之间的差胡仍照算。若本局有荤底，三家的荤底也全部由包庄者承担。</p>
            </div>
          </details>
