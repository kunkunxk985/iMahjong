        ...
        <div className="rules-body">
          ...
          <section className="rules-section">
            ...
            <ol className="rules-steps">
              <li>先算每家的牌面胡数和幺数。</li>
              <li>飘荤先把<b>飘荤者的牌面胡数 ×2</b>；牌面胡数本身不修改。</li>
              <li>两家先算飘荤后的胡差；这一笔涉及庄家时，<b>胡差整体 ×2</b>。幺差不翻倍，最后另算幺差。</li>
              <li>飘荤胡家再向另外三家各收 30 分荤底；包庄时由包庄者承担相应份额。</li>
            </ol>
            <div className="rule-formula" aria-label="结算公式">
              <code>飘荤后胡数 = 牌面胡 × 飘荤倍率</code>
              <code>两两胡差 = (A 飘荤后胡 − B 飘荤后胡) ×（涉及庄家 ? 2 : 1）</code>
            </div>
            <div className="rule-example">
              <b>例：飘荤闲家 17 胡，对庄家 6 胡</b>
              <span>先算 17×2=34，再算 34−6=28；因涉及庄家，最终胡差为 28×2=<strong>56 胡</strong>。</span>
              <small>庄家倍率不直接改庄家的牌面胡，也不翻幺差或荤底。</small>
            </div>
          </section>
